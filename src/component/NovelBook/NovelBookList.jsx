...
export const NovelBookList = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      const bookRef = doc(db, "Books", "All_Genre", "NovelBook", selectBook.book);
  ...
  const confirmUpdate = async () => {
    setLoading(true);
    try {
      const bookRef = doc(db, "Books", "All_Genre", "NovelBook", updatedBook.id);
      const newData = {
  ...
  return (
    <section>
      <div className="container w-auto">
        {/* <SearchNovelBook onSearch={handleSearch}/> */}
